...
<div class="admin-index-page">
    ...
    <div class="admin-index-card">
        <form method="POST" action="{{ route('admin.guru.import') }}" enctype="multipart/form-data" class="admin-import-form">
            ...
            <a href="{{ asset('templates/template_import_guru.xlsx') }}" download class="admin-btn-outline" style="background:#f1f5f9; color:#475569; text-decoration:none; display:inline-block; margin-left: 10px;">Download Template</a>
        </form>
