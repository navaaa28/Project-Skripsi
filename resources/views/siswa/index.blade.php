...
<div class="admin-index-page">
    ...
    <div class="admin-index-card">
        <form method="GET" action="{{ route('admin.siswa.index') }}" class="admin-filter-form">
            <label class="admin-muted">Filter Kelas</label>
            ...
            <input type="text" name="q" value="{{ request('q') }}" class="admin-input" placeholder="Cari Nama/NIPD/NISN">
            <button class="admin-btn-outline" type="submit">Cari</button>
        </form>
    </div>
